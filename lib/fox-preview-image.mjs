import { openBlock as i, createElementBlock as u, createElementVNode as n, defineComponent as K, ref as d, reactive as Q, computed as A, onMounted as ee, watchEffect as E, resolveComponent as $, createBlock as te, Teleport as oe, createVNode as w, Transition as le, withCtx as ne, normalizeStyle as M, Fragment as O, renderList as se, createCommentVNode as S, toDisplayString as V } from "vue";
function C(e) {
...
function Re(e, t) {
  return i(), u("svg", ke, Fe);
}
const Se = /* @__PURE__ */ g(Me, [["render", Re]]);
const Ie = {}, Be = {
  viewBox: "0 0 1024 1024",
  "aria-hidden": "true",
  "aria-role": "button",
...
function Ee(e, t) {
  return i(), u("svg", Be, Ae);
}
const Oe = /* @__PURE__ */ g(Ie, [["render", Ee]]);
const Ve = {}, De = {
  viewBox: "0 0 1024 1024",
  "aria-hidden": "true",
  "aria-role": "button",
...
function He(e, t) {
  return i(), u("svg", De, je);
}
const We = /* @__PURE__ */ g(Ve, [["render", He]]);
const Ne = {}, Te = {
  viewBox: "0 0 1024 1024",
  "aria-hidden": "true",
  "aria-role": "button",
  "aria-label": "\u653E\u5927",
  class: "svg"
}, Pe = /* @__PURE__ */ n("path", { d: "M325.3196818 850.33221435c-9.66522217-9.66522217-10.23376465-24.62036133-1.58203125-33.81591797l290.82183838-290.84655761c12.48321533-11.84051513 12.43377685-14.93041992 1e-8-27.36419678L323.73765055 207.50842285C315.06119792 198.31286621 315.65445964 183.35772705 325.3196818 173.69250489c9.83825684-9.83825684 25.18890381-10.38208008 34.33502198-1.26068116l323.03100586 323.03100586c3.97979737 3.97979737 5.75958252 9.14611817 6.08093262 14.51019288l-1e-8 4.05395507c-0.34606934 5.36407471-2.1258545 10.53039551-6.08093261 14.51019287L359.65470378 851.59289551C350.50858561 860.6895752 335.1332194 860.14575195 325.3196818 850.33221435z" }, null, -1), Xe = [
  Pe
];
function Ye(e, t) {
  return i(), u("svg", Te, Xe);
}
const qe = /* @__PURE__ */ g(Ne, [["render", Ye]]);
const Ue = K({
  name: "FoxPreviewImage",
  components: { ZoomOut: we, ZoomIn: xe, RotateLeft: Oe, RotateRight: We, Close: Se, ArrowRight: qe },
  props: {
    modelValue: {
      type: Boolean,
      default: !1
  ...
  setup(e, { emit: t }) {
    let r = d(!1), f = d(0), s = d(0), h = d(0), a = d(1), c = d(0), v = d(0), _ = d(0), p = d(0), m = d([]), l = Q({
      x: 0,
      y: 0
    });
    const k = () => {
      ...
      r.value = !1, t("update:modelValue", r.value);
    }, D = (o) => {
      if (f.value === 1) {
        const { x, y: R } = o, z = x - l.x, F = R - l.y;
        _.value = z + _.value - c.value, p.value = F + p.value - v.value, requestAnimationFrame(() => {
          c.value = z, v.value = F;
        });
      }
    }, B = () => {
      ...
      const o = m.value.length || 0;
      s.value > 0 ? s.value-- : s.value = o - 1, h.value = 0, a.value = 1, _.value = 0, p.value = 0, l.x = 0, l.y = 0, c.value = 0, v.value = 0;
    }, q = () => {
      const o = m.value.length || 0;
      s.value < o - 1 ? s.value++ : s.value = 0, h.value = 0, a.value = 1, _.value = 0, p.value = 0, l.x = 0, l.y = 0, c.value = 0, v.value = 0;
    }, U = A(() => parseFloat(a.value.toFixed(1))), G = A(() => `${s.value + 1}/${m.value.length}`);
    ee(() => {
      k();
    });
    const J = (o) => o.scrollHeight > o.clientHeight;
    return E(() => {
      r.value = e.modelValue, e.modelValue ? (J(document.body) && (document.body.style.paddingRight = X() + "px"), document.body.style.overflow = "hidden") : document.body.setAttribute("style", "");
    }), E(() => {
      const o = C(e.src);
      s.value = 0, o === "string" ? (h.value = 0, a.value = 1, _.value = 0, p.value = 0, l.x = 0, l.y = 0, c.value = 0, v.value = 0, m.value = [e.src]) : o === "array" && (m.value = e.src, h.value = 0, a.value = 1, _.value = 0, p.value = 0, l.x = 0, l.y = 0, c.value = 0, v.value = 0, m.value = e.src);
    }), {
      flag: r,
      status: f,
      active: s,
...
function Qe(e, t, r, f, s, h) {
  const a = $("Close"), c = $("ArrowRight"), v = $("ZoomOut"), _ = $("ZoomIn"), p = $("RotateLeft"), m = $("RotateRight");
  return i(), te(oe, { to: "body" }, [
    w(le, null, {
      default: ne(() => [
        e.flag ? (i(), u("div", {
          key: 0,
          ...
          n("div", {
            ...
            (i(!0), u(O, null, se(e.uri, (l, k) => (i(), u(O, { key: k }, [
              e.active === k ? (i(), u("div", {
                key: 0,
          ...
          e.uri && e.uri.length > 1 ? (i(), u("div", {
            ...
            n("div", {
              ...
              w(c, { class: "owl-preview-operate-icon owl-preview-operate-icon-left" })
            ]),
            n("div", {
              class: "owl-preview-operate-item",
              onClick: t[7] || (t[7] = (...l) => e.next && e.next(...l))
            }, [
              w(c, { class: "owl-preview-operate-icon owl-preview-operate-icon" })
            ])
          ], 4)) : S("", !0),
          n("div", {
...
const I = /* @__PURE__ */ g(Ue, [["render", Qe]]), t3 = (e) => {
