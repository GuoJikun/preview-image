    ...
    <div id="app">
        <div class="preview">
            ...
            <div class="preview-item">
                <h2>基础用法--设置宽高1</h2>
                <div class="preview-item-ctx">
                    <button class="button" @click="show2">点击查看预览界面</button>
                    <button class="button" @click="switchImage">切换图片</button>
                    <owl-preview-image v-model="visiable2" :src="b" width="90vw" height="90vh"></owl-preview-image>
                </div>
            </div>
        </div>
    </div>
